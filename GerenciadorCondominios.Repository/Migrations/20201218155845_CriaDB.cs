...
namespace GerenciadorCondominios.Repository.Migrations
{
    public partial class CriaDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoRecursos", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicoPredios", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "065e4629-4e92-43d3-8083-79bfcdf8908b", "491f4cc8-c65a-40f2-bb4a-14bc2a387a3b", "Morador do Predio", "Morador", "MORADOR" },
                    { "7160c7d9-caf3-44c0-bcee-3482d66ec514", "9fe5e22b-b6b3-40be-87e0-465b1b7b7c2d", "Sindico do Predio", "Sindico", "SINDICO" },
                    { "27582f1b-0f8a-4067-be34-3ea453abaaf2", "f440d994-cd1f-4e92-9293-26bba70a9d82", "Administrador do Predio", "Administrador", "ADMINISTRADOR" }
                });
