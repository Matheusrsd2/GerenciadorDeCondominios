...
using GerenciadorCondominios.Repository.Mapping;
...
namespace GerenciadorCondominios.Repository
{
    public class Context : IdentityDbContext<Usuario, Roles, string>
    {
        public DbSet<Aluguel> Alugueis { get; set; }
        public DbSet<Apartamento> Apartamentos { get; set; }
        public DbSet<Evento> Eventos { get; set; }
        public DbSet<Roles> Funcoes { get; set; }
